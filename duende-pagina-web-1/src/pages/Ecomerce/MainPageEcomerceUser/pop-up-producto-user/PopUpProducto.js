    ...
    <div className="popup-container">
      <div className="popup-content">
        <div className="left-side-popup">
            <img src={Producto}alt={producto.subtitulo} /*src={producto.imagen} alt={producto.subtitulo}*/ />
        ...
        <div className="right-side-popup">
            ...
            <p className="texto-pequenno-pop-up">Categoría: {producto.categoria}</p>
            <p className="Descripcion-pop-up">{producto.descripcion}</p>
            <p className="texto-pequenno-pop-up">Disponibles: {producto.cantidadDisponible}</p>
